...
/**
 * Converter
 * Spécifie COMMENT on passe d'une donnée au format String (l'id du genre passé en paramètre de la requête HTTP)
 * à un Genre
 */
...
public class GenreConverter implements Converter<String, Genre>{
	...
	@Override
	public Genre convert(String idFormatString) {
		...
		return filmService.consulterGenreParId(idFormatLong);
	}
